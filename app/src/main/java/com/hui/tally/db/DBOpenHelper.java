...
//      向typetb表当中插入元素
        ...
        db.execSQL(sql,new Object[]{"Daily necessities", R.mipmap.ic_riyongpin,R.mipmap.ic_riyongpin_fs,0});
        ...
        db.execSQL(sql,new Object[]{"Education", R.mipmap.ic_xuexi,R.mipmap.ic_xuexi_fs,0});
        ...
        db.execSQL(sql,new Object[]{"Utility paid", R.mipmap.ic_shuidianfei,R.mipmap.ic_shuidianfei_fs,0});
        ...
        db.execSQL(sql,new Object[]{"Sell", R.mipmap.in_ershoushebei,R.mipmap.in_ershoushebei_fs,1});
